# 31.ssh登入信息-ssh login banner

## 範本

* /etc/profile.d/ssh-login-info.sh
...
```bash
sudo chmod 0755 /etc/profile.d/ssh-login-info.sh
```

zsh 設定在 `~/.zshrc` 文件的一開始

## ASCII art

* 轉置工具: https://ascii-generator.site/t/
* 圖片: https://www.asciiart.eu
